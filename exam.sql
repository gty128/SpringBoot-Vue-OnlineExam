...
CREATE TABLE `exam_manage` (
  ...
  `exam_date` varchar(10) COLLATE utf8_bin DEFAULT NULL COMMENT '考试日期',
...
) ENGINE=InnoDB AUTO_INCREMENT=20190014 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='考试管理表';
...
INSERT INTO `exam_manage` VALUES (20190006, '2017年上期期末考试', '软件工程xxxxx', 1005, '2019-03-21', 120, '2018', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
...
INSERT INTO `message` VALUES (36, '留言', '留言内容\n', '2021-07-31');
INSERT INTO `message` VALUES (37, 'heheh', 'hahah \n', '2022-01-19');
COMMIT;
...
INSERT INTO `replay` VALUES (35, 22, 'test', '2021-07-31');
INSERT INTO `replay` VALUES (35, 23, 'heheh ', '2021-07-31');
INSERT INTO `replay` VALUES (27, 24, '1111', '2022-01-19');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='成绩管理表';
...
INSERT INTO `score` VALUES (32, 20190001, 20154084, '计算机网络', NULL, 0, NULL, '2021-08-01');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `student` VALUES (20154001, '隔壁老王', '2015', '计算机科学与技术', '大二', '软件工程学院', '13585439532', 'gblw@163.com', '123456', '3412312', '男', '2');
...
INSERT INTO `student` VALUES (20155009, '张无忌', '大一', '九阳神功专业', '二班', '九阳神功学院', '110', '111@qq.com', '123456', '111111111111111111', '男', '2');
INSERT INTO `student` VALUES (20155010, '小昭', '大一', '倚天屠龙', '三班', '倚天屠龙学院', '110', '12@qq.com', '123456', '111111111111111112', '女', '2');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `teacher` VALUES (20081001, '张小智', '软件工程学院', '男', '13598458442', '13598458442@163.com', '123456', '423423283498', '讲师', '1');
